...
<div class="row">
	<div class="col-12">
		<h3 class="mr-b-10"><i class="fa fa-gear"></i> <?= $_session_settings ?> &nbsp; | &nbsp;&nbsp;<i onclick="location.reload();" class="fa fa-refresh pointer " title="Reload data"></i></h3>
	</div>
</div>
<div class="row">
			     <div class="col-6">
...
<div class="col-12">
  ...
  <div class="input-group-2">
                <span class="group-item group-item-r pd-2p5 text-center align-middle"><?= $_min ?></span>
            </div>
        </div>
    </td>
	</tr>
