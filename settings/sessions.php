...
<div class="row">
	<div class="col-12">
		<h3 class="mr-b-10"><i class="fa fa-gear"></i> <?= $_admin_settings ?> &nbsp; | &nbsp;&nbsp;<i onclick="location.reload();" class="fa fa-refresh pointer " title="Reload data"></i></h3>
	</div>
</div>
<div class="row">
          <div class="col-6">
            ...
            <div class="row">
              ...
              foreach (file('./include/config.php') as $line) {
                ...
                if ($value == "" || $value == "mikhmon") {
                    ...
                    <div class="col-12">
                        <div class="box bmh-75 box-bordered box-tile-muted <?= $color[rand(1, 11)]; ?>">
                                <div class="box-group">
